export const binaryTreesData = [
  ...
  },
  {
    ...
    algorithm: [
      "Create a HashMap of <int, int> and store inorder values and indexes(from i=0 to inorder.length-1)",
      "Return : buildTree(preorder, 0, preorder.length-1, inorder, 0, inorder.length-1, map)",
      "Inside function: public TreeNode (int[] preorder,int preStart,int preEnd, int[] inorder,int inStart,int inEnd, HashMap<Integer,Integer> map)",
      "  - If (preStart > preEnd || inStart > inEnd), return null",
      "  - Create new root node variable using preorder[preStart]",
      "  - Create inRoot variable = map.get(root.val)",
  ...
  },
  {
    ...
    algorithm: [
      ...
      "Call: BuildTree(inorder, 0, inorder.length-1, postorder, 0, postorder.length-1, HashMap<Integer,Integer> map)",
      "Inside function: public TreeNode (int[] inorder,int inStart,int inEnd, int[] postorder,int postStart,int postEnd, HashMap<Integer,Integer> map)",
      "  - If invalid range, return null",
      "  - Create TreeNode root node using postorder[postEnd]",
      "  - Create inRoot variable = map.get(root.val)",
      "  - numsLeft = inRoot – inStart",
  ...
  },
  {
    ...
    algorithm: [
      ...
      '    - If temp == null, append "n " to sb and continue',
      '    - sb.append(temp.val + " ")',
